...
public class Charmeleon : PokemonBase
{
    public Charmeleon() : base(false, 0, 0, Gender.Male, 0, 0, 0, 0, 0, 0, 0, 0)
    {
    ...
    public override void Awake()
    {
        ...
        eggCycles = 20;
        actionPoints = GetComponent<Charmeleon>().stats.spd; // Asegúrate de que esto esté correcto
    ...
    void Start()
    {
        ...
        attackList.Add(new LearnedAttack(AttackCatalog.GetAttackByName("Scary Face"), 37));
        attackList.Add(new LearnedAttack(AttackCatalog.GetAttackByName("Inferno"), 48));
        attackList.Add(new LearnedAttack(AttackCatalog.GetAttackByName("Flare Blitz"), 54));
