...
public class Raichu : PokemonBase
{   
    
    public Raichu() : base(false, 0, 0, Gender.Male, 0, 0, 0, 0, 0, 0, 0, 0)
        {
    ...
    public override void Awake()
    {
        ...
        eggCycles = 10;
        actionPoints = GetComponent<Raichu>().stats.spd; // Asegúrate de que esto esté correcto
    ...
    void Start()
    {
        ...
        attackList.Add(new LearnedAttack(AttackCatalog.GetAttackByName("Agility"), 1));
        attackList.Add(new LearnedAttack(AttackCatalog.GetAttackByName("Charm"), 1));
        attackList.Add(new LearnedAttack(AttackCatalog.GetAttackByName("Discharge"), 1));
        attackList.Add(new LearnedAttack(AttackCatalog.GetAttackByName("Double Team"), 1));
        attackList.Add(new LearnedAttack(AttackCatalog.GetAttackByName("Electro Ball"), 1));
        attackList.Add(new LearnedAttack(AttackCatalog.GetAttackByName("Feint"), 1));
        attackList.Add(new LearnedAttack(AttackCatalog.GetAttackByName("Growl"), 1));
        attackList.Add(new LearnedAttack(AttackCatalog.GetAttackByName("Iron Tail"), 1));
        attackList.Add(new LearnedAttack(AttackCatalog.GetAttackByName("Light Screen"), 1));
        ...
        attackList.Add(new LearnedAttack(AttackCatalog.GetAttackByName("Spark"), 1));
        ...
        attackList.Add(new LearnedAttack(AttackCatalog.GetAttackByName("Thunder"), 1));
        attackList.Add(new LearnedAttack(AttackCatalog.GetAttackByName("Thunder Shock"), 1));
        attackList.Add(new LearnedAttack(AttackCatalog.GetAttackByName("Thunder Wave"), 1));
        attackList.Add(new LearnedAttack(AttackCatalog.GetAttackByName("Thunderbolt"), 5));
