...
public class Sylveon : PokemonBase
{
    public Sylveon() : base(false, 0, 0, Gender.Male, 0, 0, 0, 0, 0, 0, 0, 0)
    {
    ...
    public override void Awake()
    {
        ...
        eggCycles = 35;
        actionPoints = GetComponent<Sylveon>().stats.spd; // Asegúrate de que esto esté correcto
    ...
    void Start()
    {
        ...
        attackList.Add(new LearnedAttack(AttackCatalog.GetAttackByName("Light Screen"), 25)); // Aprendido en nivel 55
        attackList.Add(new LearnedAttack(AttackCatalog.GetAttackByName("Draining Kiss"), 30)); // Aprendido en nivel 55
        attackList.Add(new LearnedAttack(AttackCatalog.GetAttackByName("Misty terrain"), 35)); // Aprendido en nivel 55
        attackList.Add(new LearnedAttack(AttackCatalog.GetAttackByName("Skill Swap"), 40)); // Aprendido en nivel 55
        attackList.Add(new LearnedAttack(AttackCatalog.GetAttackByName("Psych Up"), 45)); // Aprendido en nivel 55
        attackList.Add(new LearnedAttack(AttackCatalog.GetAttackByName("Moonblast"), 50)); // Aprendido en nivel 55
    ...
    private void AddTMMoves()
    {
        ...
        attackList.Add(new LearnedAttack(AttackCatalog.GetAttackByName("Dazling Gleam"), 0)); // TM
        ...
        attackList.Add(new LearnedAttack(AttackCatalog.GetAttackByName("Misty Terrain"), 0)); // TM
        ...
        attackList.Add(new LearnedAttack(AttackCatalog.GetAttackByName("Misty Explosion"), 0)); // TM
