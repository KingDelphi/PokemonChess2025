...
public class Flareon : PokemonBase
{
    public Flareon() : base(false, 0, 0, Gender.Male, 0, 0, 0, 0, 0, 0, 0, 0)
    {
    ...
    public override void Awake()
    {
        ...
        eggCycles = 35;
        actionPoints = GetComponent<Flareon>().stats.spd; // Asegúrate de que esto esté correcto
    ...
    void Start()
    {
        ...
        attackList.Add(new LearnedAttack(AttackCatalog.GetAttackByName("Smog"), 20)); // Aprendido en nivel 50
        attackList.Add(new LearnedAttack(AttackCatalog.GetAttackByName("Bite"), 25)); // Aprendido en nivel 55
        attackList.Add(new LearnedAttack(AttackCatalog.GetAttackByName("Fire Fang"), 30)); // Aprendido en nivel 55
        attackList.Add(new LearnedAttack(AttackCatalog.GetAttackByName("Fire Spin"), 35)); // Aprendido en nivel 55
        attackList.Add(new LearnedAttack(AttackCatalog.GetAttackByName("Lava Plume"), 40)); // Aprendido en nivel 55
        attackList.Add(new LearnedAttack(AttackCatalog.GetAttackByName("Scary Face"), 45)); // Aprendido en nivel 55
        attackList.Add(new LearnedAttack(AttackCatalog.GetAttackByName("Flare Blitz"), 50)); // Aprendido en nivel 55
    ...
    private void AddTMMoves()
    {
        ...
        attackList.Add(new LearnedAttack(AttackCatalog.GetAttackByName("Burning Jealousy"), 0)); // TM
